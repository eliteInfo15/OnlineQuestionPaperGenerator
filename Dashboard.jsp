...
@media screen and (max-width: 600px) {
    ...
    <body >
        ...
        <ul id="slide-out" class="side-nav fixed  custom-scrollbar " style="width: 240px; background-color: #4b3e8a; transform: translateX(0%)" >
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <li><a class="collapsible-header waves-effect arrow-r" href="Dashboard.jsp"><i class="fa fa-home white-text" sytle="width:10px"></i> Home</a>
                    ...
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-graduation-cap white-text"></i> Manage Courses</a>
                     ...
                     <li class=""><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-file-alt white-text"></i>Question Papers</a>
       ...
       <nav class="navbar fixed-top navbar-toggleable-md white navbar-expand-lg scrolling-navbar double-nav">
            <!-- SideNav slide-out button -->
                ...
                <a class="navbar-brand" Style="color: #4b3e8a; "ref="#"> <i class="fas fa-book-reader prefix  fa-lg"></i><b style="font-size: 19px;">Question Paper Generator</b></a>
  ...
  <div class="card-body">
    ...
    <!-- Button -->
    <a href="#" class="btn btn-primary">Manage Instructors</a>
...
<!-- Card -->
  ...
  <div class="card-body">
    ...
    <!-- Button -->
    <a href="#" class="btn btn-primary">Manage Questions</a>
...
<!-- Card --></div>
  ...
  <div class="card-body">
    ...
    <!-- Button -->
    <a href="#" class="btn btn-primary">Manage Units</a>
...
<!-- Card -->
  ...
  <div class="card-body">
    ...
    <!-- Button -->
    <a href="#" class="btn btn-primary">Question paper</a>
